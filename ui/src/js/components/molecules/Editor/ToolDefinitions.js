...
export default [
  {
    ...
    perspectives: {
      0: {
        "icon/href": threatHumanAccidentalSymbol,
        "icon/height": accidentalHeight,
      },
      1: {
        "icon/href": threatHumanAccidentalSymbolOutline,
        "icon/height": accidentalHeight,
      },
      2: {
        "icon/href": threatHumanAccidentalSymbolShadow,
        "icon/height": accidentalHeight,
      },
    },
    existsIn: {
  ...
  },
  {
    ...
    perspectives: {
      0: {
        "icon/href": threatHumanDeliberateSymbol,
        "icon/height": deliberateHeight,
      },
      1: {
        "icon/href": threatHumanDeliberateSymbolOutlined,
        "icon/height": deliberateHeight,
      },
      2: {
        "icon/href": threatHumanDeliberateSymbolShaded,
        "icon/height": deliberateHeight,
      },
    },
    existsIn: {
  ...
  },
  {
    ...
    perspectives: {
      ...
      1: {
        "icon/href": threatNonHumanSymbolOutlined,
        "icon/height": nonHumanHeight,
      },
      2: {
        "icon/href": threatNonHumanSymbolShaded,
        "icon/height": nonHumanHeight,
      },
    },
    existsIn: {
  ...
  },
  {
    ...
    perspectives: {
      0: {
        "icon/href": unwantedIncidentSymbol,
        "body/strokeDasharray": "",
        "icon/height": incidentHeight,
      },
      1: {
        "icon/href": unwantedIncidentSymbolOutlined,
        "body/strokeDasharray": "8, 4",
        "icon/height": incidentHeight,
      },
      2: {
        "icon/href": unwantedIncidentSymbolShaded,
        "body/strokeDasharray": "8, 4",
        "icon/height": incidentHeight,
      },
    },
  ...
  },
  {
    ...
    perspectives: {
      ...
      1: {
        "icon/href": stakeholderSymbolOutlined,
        "icon/height": stakeholderHeight,
      },
      2: {
        "icon/href": stakeholderSymbolShaded,
        "icon/height": stakeholderHeight,
      },
    },
    existsIn: {
  ...
  },
  {
    ...
    perspectives: {
      ...
      1: {
        "icon/href": indirectAssetSymbolOutlined,
        "icon/height": indirectHeight,
      },
      2: {
        "icon/href": indirectAssetSymbolShaded,
        "icon/height": indirectHeight,
      },
    },
    existsIn: {
  ...
  },
  {
    ...
    perspectives: {
      0: {
        "icon/href": vulnerabilitySymbol,
        "icon/height": vulnerabilityHeight,
      },
      1: {
        "icon/href": vulnerabilitySymbolOutlined,
        "icon/height": vulnerabilityHeight,
      },
      2: {
        "icon/href": vulnerabilitySymbolShaded,
        "icon/height": vulnerabilityHeight,
      },
    },
    existsIn: {
  ...
  },
  {
    ...
    perspectives: {
      0: {
        "icon/href": treatmentSymbol,
        "body/strokeDasharray": "",
        "icon/height": treatmentHeight,
      },
      1: {
        "icon/href": treatmentSymbolOutlined,
        "body/strokeDasharray": "8, 4",
        "icon/height": treatmentHeight,
      },
      2: {
        "icon/href": treatmentSymbolShaded,
        "body/strokeDasharray": "8, 4",
        "icon/height": treatmentHeight,
      },
    },
  ...
  },
  {
    ...
    perspectives: {
      0: {
        "icon/href": indicatorSymbol,
        "body/strokeDasharray": "",
        "icon/height": indicatorHeight,
      },
      1: {
        "icon/href": indicatorSymbol,
        "body/strokeDasharray": "",
  ...
  {
    shapeFn: () => new joint.shapes.coras.legalElement(),
    width: 250,
    height: 150,
    iconHeight: legalCorasHeight,
    icon: legalCoras,
    text: "Law",
    id: "law",
    perspectives: {
      0: { "icon/href": legalCoras, "icon/height": legalCorasHeight },
      1: { "icon/href": legalCoras, "icon/height": legalCorasHeight },
      2: { "icon/href": legalCoras, "icon/height": legalCorasHeight },
    },
    existsIn: {
      threat: true,
      treatment: true,
